...
export const PERMISOS_POR_ROL: Record<RolUsuario, Permiso[]> = {
  superadmin: [
    ...
    { recurso: 'vehiculos', accion: 'ver' }, { recurso: 'vehiculos', accion: 'crear' }, { recurso: 'vehiculos', accion: 'editar' }, { recurso: 'vehiculos', accion: 'eliminar' },
  ...
  trabajador: [
    ...
    { recurso: 'vehiculos', accion: 'ver' }, { recurso: 'vehiculos', accion: 'crear' }, { recurso: 'vehiculos', accion: 'editar' },
